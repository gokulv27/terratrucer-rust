    ...
    <div className="min-h-screen bg-background flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      >
        <div className="flex justify-center mb-6">
          <Link
            to="/"
            className="h-12 w-12 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-xl flex items-center justify-center shadow-lg shadow-brand-primary/20 hover:scale-105 transition-transform"
          >
        ...
        <div className="bg-surface border border-border py-8 px-4 shadow-2xl rounded-2xl sm:px-10">
          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-surface text-text-secondary font-medium">New here?</span>
              </div>
            </div>
